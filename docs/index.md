...
2. Respect **package boundaries** — `beneesse_api` is consumed only by `beneesse_mobile`.
...
5. **Coverage** — 100% on workspace packages, app BLoCs, and repositories; app presentation excluded; `beneesse_ui` requires widget + golden tests.
