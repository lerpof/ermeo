...
/// Builds Material 3 [ThemeData] instances from Ermeo semantic tokens.
abstract final class ErTheme {
  /// Light theme configured with Ermeo semantic tokens.
  static ThemeData get light => _build(ErSemanticTokens.light, Brightness.light);

  /// Dark theme configured with Ermeo semantic tokens.
  static ThemeData get dark => _build(ErSemanticTokens.dark, Brightness.dark);

  static bool get _skipGoogleFonts =>
      kIsWeb == false && Platform.environment['FLUTTER_TEST'] == 'true';

  static TextTheme _resolveTextTheme(
    ErSemanticTokens tokens,
  ...
  static ThemeData _build(ErSemanticTokens tokens, Brightness brightness) {
