...
/// Size scale for [ErTextField].
enum ErTextFieldSize {
  standard,
  search,
}
...
class ErTextField extends StatelessWidget {
  const ErTextField({
    ...
    this.maxLines = 1,
    this.size = ErTextFieldSize.standard,
  });
  ...
  Widget build(BuildContext context) {
    ...
    final verticalPadding = size == ErTextFieldSize.search
        ? spacing.componentGap + spacing.inlineGap / 2
        : spacing.componentGap;
    final horizontalPadding = size == ErTextFieldSize.search
    ...
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        isDense: size == ErTextFieldSize.standard,
      ),
    );
  }
}
