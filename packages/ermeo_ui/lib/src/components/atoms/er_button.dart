...
class ErButton extends StatelessWidget {
  ErButton({
    ...
    this.size = ErButtonSize.md,
    this.icon,
    this.iconPosition = ErButtonIconPosition.leading,
  ...
  const ErButton.icon({
    ...
    this.isLoading = false,
        ...
        iconPosition = ErButtonIconPosition.leading,
        _isIconOnly = true;

  final String? label;
  final VoidCallback? onPressed;
  final ErButtonVariant variant;
  final ErButtonSize size;
  final IconData? icon;
  final ErButtonIconPosition iconPosition;
  ...
  Widget build(BuildContext context) {
    final metrics = ErButtonStyle.resolve(
      context,
      variant: variant,
      size: size,
      enabled: _enabled,
  ...
  Widget _buildButtonContent({
    required ErButtonMetrics metrics,
  ...
  Widget _buildChild(ErButtonMetrics metrics) {
    if (isLoading) {
      return SizedBox(
    ...
    final children = iconPosition == ErButtonIconPosition.leading
        ? <Widget>[
            iconWidget,
